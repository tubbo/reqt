...
function find(collection) {
  return new _store2.default(collection);
}
...
var Store = function () {
  function Store(collection) {
    var request = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : { method: 'get' };
  ...
  _createClass(Store, [{
    ...
    value: function where() {
      ...
      (0, _lodash.extend)(this.query, params);
      return this;
    }
  }, {
    key: 'sort',
    value: function sort(by, direction) {
      this.query.sort = { by: by, direction: direction };
      return this;
    }
  }, {
    key: 'then',
...
var decodeComponent = __webpack_require__(6);
